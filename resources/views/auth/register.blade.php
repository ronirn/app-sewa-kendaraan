...
<head>
  ...
  <title>Register - KendaraanKu</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{ asset('vendor/admin/assets/img/favicon.png') }}" rel="icon">
  <link href="{{ asset('vendor/admin/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="{{ url('/') }}" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">KendaraanKu</span>
                </a>
              </div><!-- End Logo -->

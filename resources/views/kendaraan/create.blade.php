        ...
        <form action="{{ route('kendaraan.store') }}" method="POST">
            ...
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5" id="no_pol" name="no_pol" value="{{ old('no_pol') }}" required>
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="no_mesin" class="text-sm font-medium text-gray-900 block mb-2">Nomor Mesin</label>
                    <input type="text" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5" id="no_mesin" name="no_mesin" value="{{ old('no_mesin') }}" required>
                </div>
                <div class="col-span-6">
                    <label for="jenis_mobil" class="text-sm font-medium text-gray-900 block mb-2">Jenis Mobil</label>
                    <select name="jenis_mobil" id="jenis_mobil" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5" required>
                ...
                <div class="col-span-6">
                    ...
                    <input type="text" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5" id="nama_mobil" name="nama_mobil" value="{{ old('nama_mobil') }}" required>
                </div>
                <div class="col-span-6">
                ...
                <div class="col-span-6">
                    ...
                    <input type="text" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5" id="kapasitas" name="kapasitas" value="{{ old('kapasitas') }}" required>
                </div>
            </div>

            <div class="flex justify-start mt-6">
                <button class="text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:ring-green-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center shadow-md transition duration-300 ease-in-out" type="submit">Simpan</button>
            </div>
        </form>
    </div>
</div>
